...
INSERT INTO question_to_game (`ID_type`, `question`, `answer`, `correct_answer`, `wrong_answer`, `answer1`, `answer2`, `answer3`)
VALUES
    (1, 'Jaką stolicę ma Gwinea Równikowa?', 'Malabo', 0, 0, 'Mongomo', 'Rebola', 'Machinda'),
    (1, 'Jaką stolicę ma Kamerun?', 'Jaunde', 0, 0, 'Kumbo', 'Melong', 'Obala'),
    (1, 'Jaką stolicę ma Kenia?', 'Nairobi', 0, 0, 'Kisumu', 'Marsabit', 'Mombasa'),
    (1, 'Jaką stolicę ma Komory?', 'Moroni', 0, 0, 'Mirontsi', 'Fomboni', 'Domoni'),
    (1, 'Jaką stolicę ma Kongo?', 'Brazzaville', 0, 0, 'Gamboma', 'Bouansa', 'Owando'),
    (1, 'Jaką stolicę ma Lesotho?', 'Maseru', 0, 0, 'Leribe', 'Mafeteng', 'Quthing'),
    (1, 'Jaką stolicę ma Liberia?', 'Monrovia', 0, 0, 'Grand Gedeh', 'River Cess', 'Bong'),
    (1, 'Jaką stolicę ma Libia?', 'Trypolis', 0, 0, 'Sabrata', 'Tawurgha', 'Al-Haszan'),
    (1, 'Jaką stolicę ma Madagaskar?', 'Antananarywa', 0, 0, 'Atsinanana', 'Soavinandriana', 'Amboasary'),
    (1, 'Jaką stolicę ma Malawi?', 'Lilongwe', 0, 0, 'Chintheche', 'Ekwendeni', 'Nkhata Bay'),
    (1, 'Jaką stolicę ma Mali?', 'Bamako', 0, 0, 'Kalabancoro', 'Bandiagara', 'Taoudenni'),
    (1, 'Jaką stolicę ma Maroko?', 'Rabat', 0, 0, 'Nador', 'Tantan', 'Wazzan'),
    (1, 'Jaką stolicę ma Mauretania?', 'Nawakszut', 0, 0, 'Bababi', 'Maghama', 'Timbadgha'),
    (1, 'Jaką stolicę ma Mauritius Port?', 'Louis', 0, 0, 'Goodlands', 'Port Louis', 'Saint-Pierre'),
    (1, 'Jaką stolicę ma Mozambik?', 'Maputo', 0, 0, 'Cuamba', 'Inhambane', 'Morrumbene'),
    (1, 'Jaką stolicę ma Namibia?', 'Windhuk', 0, 0, 'Eenhana', 'Oranjemund', 'Otjiwarongo'),
    (1, 'Jaką stolicę ma Niger?', 'Niamey', 0, 0, 'Dakoro', 'Matameye', 'Tahoua'),
    (1, 'Jaką stolicę ma Nigeria?', 'Abudża', 0, 0, 'Abonnema', 'Igboho', 'Jimeta'),
    (1, 'Jaką stolicę ma Południowa Afryka?', 'Pretoria', 0, 0, 'Greater Kokstad', 'KwaDukuza', 'Makana'),
    (1, 'Jaką stolicę ma Republika Środkowoafrykańska?', 'Bangi', 0, 0, 'Batangafo', 'Kaga-Bandoro', 'Nola'),
    (1, 'Jaką stolicę ma Republika Zielonego Przylądka?', 'Praia', 0, 0, 'Mosteiros', 'Ribeira Grande', 'Cova Figueira'),
    (1, 'Jaką stolicę ma Rwanda?', 'Kigali', 0, 0, 'Butare', 'Gitarama', 'Ruhengeri'),
    (1, 'Jaką stolicę ma Senegal?', 'Dakar', 0, 0, 'Kaolack', 'Ziguinchor', 'Diourbel'),
    (1, 'Jaką stolicę ma Seszele?', 'Victoria', 0, 0, 'Cascade', 'Anse Etoile', 'Machabee'),
    (1, 'Jaką stolicę ma Sierra Leone?', 'Freetown', 0, 0, 'Kenema', 'Falaba', 'Kambia'),
    (1, 'Jaką stolicę ma Somalia?', 'Mogadiszu', 0, 0, 'Boorama', 'Kismaju', 'Burco'),
    (1, 'Jaką stolicę ma Eswatini?', 'Mbabane', 0, 0, 'Nhlangano', 'Hluthi', 'Malkerns'),
    (1, 'Jaką stolicę ma Sudan?', 'Chartum', 0, 0, 'Port Sudan', 'Omdurman', 'Tandalti'),
    (1, 'Jaką stolicę ma Sudan Południowy?', 'Dżuba', 0, 0, 'Malakal', 'Daga Post', 'Kapoeta'),
